...
public:
    ...
    void Resize(size_t new_size) {
        ...
        if (new_size > capacity_) {
            ...
            Fill(temp.Get(), temp.Get()+new_capacity_);
    ...
    Iterator Insert(Iterator pos, Type&& value) {
        ...
        std::move_backward(simple_vector_.Get()+dist, simple_vector_.Get()+size_, simple_vector_.Get()+size_+1);
        simple_vector_[dist] = std::move(value);
        return &simple_vector_[dist];
    }
    ...
    Iterator Erase(ConstIterator pos) {
        ...
        std::move(simple_vector_.Get()+dist+1, simple_vector_.Get()+size_,simple_vector_.Get()+dist);
        --size_;
        return &simple_vector_[dist];
    }
