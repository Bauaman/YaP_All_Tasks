...
public:
    explicit Programmer(const std::string& name, int age, Gender gender);
...
public:
    explicit Worker(const std::string& name, int age, Gender gender);
...
private:
    std::set<WorkerSpeciality> spec_;
