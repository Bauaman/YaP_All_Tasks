...
public:
	...
	iterator Emplace(const_iterator position, Args&&... args) {
        ...
        if (data_.Capacity() > Size()) {
            ...
            UninitMoveOrCopy(data_.GetAddress(), pos, new_data.GetAddress());
            UninitMoveOrCopy(data_.GetAddress()+pos, Size()-pos, new_data.GetAddress()+pos+1);
    ...
    void Reserve(size_t new_capacity) {
        ...
        UninitMoveOrCopy(data_.GetAddress(), size_, new_data.GetAddress());
        std::destroy_n(data_.GetAddress(), size_);
        data_.Swap(new_data);
    }
...
private:
    ...
    static T* UninitMoveOrCopy(T* from, size_t n, T* to) {
