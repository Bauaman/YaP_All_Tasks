...
class MapRenderer {
public:
    MapRenderer(VisualizationSettings settings) :
    render_settings_(settings)
    {}
    svg::Document/*void*/ GetSVGDoc(std::map<std::string_view, const Bus*>& buses, std::map<std::string_view, const Stop*>& stops) const;
    //svg::Document GetSVGDoc(std::map<std::string_view, const Bus*> buses) const;
    //void SetRenderSettings(VisualizationSettings settings);
